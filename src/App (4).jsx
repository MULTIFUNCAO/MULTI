...
function ProUpgrade({ onBack, onSubscribe }) {
  ...
  const pixCode = chosen
    ? `00020126580014br.gov.bcb.pix0136multi-funcao-${Date.now().toString(36).toUpperCase()}5204000053039865406${chosen.pix.replace(".","").padStart(10,"0")}5802BR5913Multi Funcao6009Sao Paulo62070503***6304`
    : "";
