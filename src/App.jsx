...
{/* Urgência */}
      ...
      <button
        onClick={() => { if (canPublish) onSuccess({ cat:form.cat, desc:form.desc, value:Number(form.value), cep:form.cep, photo:window._photoPreview||null, cepInfo, material:form.material }); }}
